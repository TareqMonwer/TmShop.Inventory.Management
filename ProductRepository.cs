...
namespace TmShop.Inventory.Management
{
    ...
    {
        private string directory = @"D:\learning\c#\TmShop.Inventory.Management\SeedData\";
        private string productsFileName = "products.csv";
        ...
        public List<Product> LoadProductsFromFile()
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("The file couln't be found!");
